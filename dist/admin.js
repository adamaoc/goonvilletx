...
var pageEditor = {
  ...
  createPane: function createPane() {
    var pane = document.createElement('div');
    pane.classList.add('edit-page-pane');
    document.body.appendChild(pane);
    return pane;
  },
  getSEOElements: function getSEOElements() {
  ...
  getEditableElements: function getEditableElements() {
    ...
    editableBlocks.forEach(function (ele, i) {
      var _ele$dataset = ele.dataset,
          name = _ele$dataset.name,
          label = _ele$dataset.label,
          type = _ele$dataset.type;
      ...
      _this.blocks[i] = blockData;
    });
  },
  buildItems: function buildItems() {
    var itemsArr = this.blocks.map(function (block) {
...
(function (global, factory) {
  ...
  function assertValidProps(tag, props, getStack) {
    ...
    if (props.dangerouslySetInnerHTML != null) {
      ...
      !(_typeof(props.dangerouslySetInnerHTML) === 'object' && HTML$1 in props.dangerouslySetInnerHTML) ? invariant_1(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://fb.me/react-invariant-dangerously-set-inner-html for more information.') : void 0;
    }
    {
...

  {
    ...
    validateProperty$1 = function validateProperty$1(tagName, name, value, canUseEventSystem) {
      ...
      if (lowerCasedName === 'is' && value !== null && value !== undefined && typeof value !== 'string') {
        warning_1(false, 'Received a `%s` for a string attribute `is`. If this is expected, cast ' + 'the value to a string.%s', typeof value === 'undefined' ? 'undefined' : _typeof(value), getStackAddendum$2());
        warnedProperties$1[name] = true;
        return true;
      }
...

  {
    ...
    warnForInvalidEventListener = function warnForInvalidEventListener(registrationName, listener) {
      if (listener === false) {
        ...
        warning_1(false, 'Expected `%s` listener to be a function, instead got a value of `%s` type.%s', registrationName, typeof listener === 'undefined' ? 'undefined' : _typeof(listener), getCurrentFiberStackAddendum$2());
      }
    };
  ...
  function getFiberTagFromObjectType(type, owner) {
    var $$typeof = (typeof type === 'undefined' ? 'undefined' : _typeof(type)) === 'object' && type !== null ? type.$$typeof : null;
      ...
      default:
        {
          ...
          invariant_1(false, 'Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s', type == null ? type : typeof type === 'undefined' ? 'undefined' : _typeof(type), info);
        }
    }
  }
  ...
  {
    var printWarning$1 = function printWarning$1(format) {
      for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        args[_key - 1] = arguments[_key];
      }
  ...
  function checkClassInstance(workInProgress) {
    ...
    var type = workInProgress.type;
    {
      ...
      if (typeof instance.getChildContext === 'function') {
        !(_typeof(type.childContextTypes) === 'object') ? warning_1(false, '%s.getChildContext(): childContextTypes must be defined in order to ' + 'use getChildContext().', name) : void 0;
      }
    }
  }
...

  {
    ...
    warnForMissingKey = function warnForMissingKey(child) {
      ...
      !(_typeof(child._store) === 'object') ? invariant_1(false, 'React Component in warnForMissingKey should have a _store. This error is likely caused by a bug in React. Please file an issue.') : void 0;
  ...
  function throwException(root, returnFiber, sourceFiber, value, renderIsExpired, renderExpirationTime, currentTimeMs) {
    ...
    if (enableSuspense && value !== null && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && typeof value.then === 'function') {
      // This is a thenable.
      var thenable = value;
  ...
  editPage: function editPage() {
    ...
    switch (path) {
      case '/':
        if (!this.paneOpen) {
          this.paneOpen = true;
          _PageEditor2.default.init('home');
        }
        break;
      default:
        _PageEditor2.default.init(path);
    }
  }
};
